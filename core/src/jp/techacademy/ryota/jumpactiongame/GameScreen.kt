...
class GameScreen(private val mGame: JumpActionGame) : ScreenAdapter() {
    ...
    init {
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.ryota.jumpactiongame")
    ...
    override fun render(delta: Float) {
        ...
        // カメラの中心を超えたらカメラを上に移動させる つまりキャラが画面の上半分には絶対行かない
    ...
    private fun updatePlaying(delta: Float) {
        ...
        mHeightSoFar = Math.max(mPlayer.x, mHeightSoFar)
